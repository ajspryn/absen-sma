    ...
    <div class="content-wrapper container-xxl p-0">
        <div class="content-header row">
            <div class="content-header col-md-9 col-12 mb-2">
                ...
                <div class="col-12">
                    <center>
                        <h2 class="content-header-title float-start mb-0">Tambah Jurnal</h2>
                    </center>
                </div>
                ...
                <div class="col-lg-12 col-md-12 col-12">
                    <div class="card card-payment">
                        <div class="card-header">
                            <h4 class="card-title">Tambah Data Jurnal</h4>
                        </div>
                        <div class="card-body">
                            <form method="POST" action="/jurnalguru" class="form" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-12">
                                        <div class="mb-2">
