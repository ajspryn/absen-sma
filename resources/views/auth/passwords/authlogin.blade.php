                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                <a href="#" class="brand-logo">
                                    <img src="sman1tajurhalang.png" height="150" alt="logo">
                                </a>
                                ...
                                <form class="auth-login-form mt-2" method="POST" action="{{ route('login') }}" >
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <input type="email" class="form-control @error('email') is-invalid @enderror" id="login-email" placeholder="Masukan email anda" aria-describedby="login-email" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus tabindex="1" autofocus />
                                        @error('email')
